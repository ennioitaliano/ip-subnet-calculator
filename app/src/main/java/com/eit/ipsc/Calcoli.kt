...
class Calcoli(private val ip1Int: Int?, private val ip2Int: Int?, private val ip3Int: Int?, private val ip4Int: Int?, private val mascheraInt: Int?) : MainActivity_Calculate() {
    ...
    fun ipBinarioArray(): Array<String> {
    ...
    fun mascheraArray(): IntArray {
        ...
        if (mascheraInt!! >= 0 && mascheraInt <= 8) {
            ...
            tmp = 8 - mascheraInt
            risultato = Math.pow(2.0, tmp.toDouble()).toInt()
        ...
        } else if (mascheraInt >= 17 && mascheraInt <= 24) {
        ...
        } else if (mascheraInt >= 25 && mascheraInt <= 32) {
    ...
    fun numIndDisp(): String {
        ...
        var num: Long
        val potenza3 = Math.pow(256.0, 3.0).toLong()
        val potenza2 = Math.pow(256.0, 2.0).toLong()
        val potenza1 = Math.pow(256.0, 1.0).toLong()
        val potenza0 = Math.pow(256.0, 0.0).toLong()
        ...
        if (mascheraInt == 32)
            ...
            num = calcolo1 - calcolo2 + 1

        return num.toString()
    }

    fun broadcastArray(): IntArray {
